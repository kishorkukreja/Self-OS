...
**Description:** AI safety company and creator of Claude, the Claude Agent SDK, and the Claude Code CLI — the primary AI infrastructure underlying Self OS.

**Key facts:**
- Creator of Claude model family (Opus, Sonnet, Haiku)
- Publishes Claude Cookbook at platform.claude.com/cookbook
