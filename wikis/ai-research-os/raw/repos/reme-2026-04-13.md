...
<p align="center">
  ...
  <a href="./README_ZH.md"><img src="https://img.shields.io/badge/????-????-orange" alt="????"></a>
...
| ? Hard to modify          | ?? Directly editable |
...
<tr><td><code>compact_tool_result</code></td><td>?? Compact long tool outputs</td><td><a href="reme/memory/file_based/components/tool_result_compactor.py">ToolResultCompactor</a> — truncates long tool outputs and stores them in <code>tool_result/</code> while keeping file references in messages</td></tr>
...
| `update_memory`    | ?? Update    | Update existing memory content or metadata                  |
| `delete_memory`    | ?? Delete   | Delete a specific memory                                    |
