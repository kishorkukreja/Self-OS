...
## Summary
auto-harness is a framework for building self-improving agentic systems where a coding agent iteratively mines failures, edits an agent implementation, gates changes against regressions, records results, and repeats. The loop is steered through `PROGRAM.md` while benchmark-specific files and live eval suites govern progress.

## Repo metadata
- **Repository:** `neosigmaai/auto-harness`
- **URL:** https://github.com/neosigmaai/auto-harness
- **Description:** Bring your own agent and build a self-improving agentic system. Automatically mine failures, optimize the agent harness, and gate against regressions.
- **Primary language:** Python
- **Language breakdown:** Python 99.4%, Dockerfile 0.6%
- **License:** MIT
- **Stars:** 485
- **Forks:** 56
- **Watchers:** 3
- **Open issues:** 3
- **Created:** 2026-04-03T21:18:14Z
- **Updated:** 2026-05-03T20:57:27Z
- **Last pushed:** 2026-04-29T05:25:34Z
- **Default branch:** main
- **Homepage:** https://www.neosigma.ai/blog/self-improving-agentic-systems
- **Topics:** none listed
- **Fetched README:** main/README.md

## Key points
- Defines an overnight loop: run benchmark → analyze → improve `agent/agent.py` → gate → record → update learnings → repeat.
- Supports tau-bench, Terminal-Bench 2.0, and BIRD-Interact style benchmarks.
- Uses a self-maintained regression suite plus full-test gating to prevent regressions.

## Why it matters
Strong match for the user’s Day/Night Shift operating model: benchmark-driven AFK harness improvement with explicit gating and durable learning logs.
