...
## Summary
OpenHarness is an open-source Python agent harness that provides tool-use, skills, memory, plugin compatibility, permissions, multi-agent coordination, and a personal-agent app called `ohmo`. It frames the harness as the infrastructure around an LLM that provides hands, eyes, memory, and safety boundaries.
...
- **Language breakdown:** Python 93.6%, TypeScript 4.6%, Shell 0.8%, PowerShell 0.5%, CSS 0.4%
- **License:** MIT
- **Stars:** 11871
- **Forks:** 1994
- **Watchers:** 70
- **Open issues:** 22
- **Created:** 2026-04-01T15:37:13Z
- **Updated:** 2026-05-04T21:17:04Z
- **Last pushed:** 2026-05-03T09:03:42Z
- **Default branch:** main
- **Homepage:** none
- **Topics:** none listed
...
## Key points
- Provides a broad agent loop/tooling stack: streaming tool calls, retry, parallel tools, cost tracking, skills, plugins, memory, and compression.
- Supports chat/platform integrations for `ohmo`, including Telegram/Discord/Slack/Feishu-style usage.
- Includes governance mechanisms such as permission modes, path/command rules, and hooks.

## Why it matters
This is directly adjacent to Hermes/Self-OS: an open harness with chat gateway, skills, memory, permissions, and multi-agent orchestration patterns worth tracking.
