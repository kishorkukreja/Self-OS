...
## Summary
Autoreason is a self-refinement framework for subjective or open-ended domains where naive critique-and-revise loops can degrade outputs. It preserves “do nothing” as a first-class option by comparing an unchanged incumbent, an adversarial revision, and a synthesis under fresh blind judges using Borda count.
...
- **Language breakdown:** TeX 80.8%, Python 19.2%
...
- **Updated:** 2026-05-02T15:06:59Z
- **Last pushed:** 2026-04-12T22:19:11Z
- **Default branch:** main
- **Homepage:** none
- **Topics:** none listed
...
## Key points
- Makes the unchanged incumbent a valid tournament candidate, preventing forced degradation.
- Uses fresh agents for critique, revision, synthesis, and judging to reduce context contamination.
- Reports results across writing tasks and CodeContests-style programming experiments.

## Why it matters
Relevant to Self-OS QA and review loops because it provides a principled alternative to unconstrained iterative refinement: restraint, blind judging, and stop conditions.
