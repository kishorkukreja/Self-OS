...
PageIndex is a Python framework from VectifyAI for **vectorless, reasoning-based retrieval augmented generation** over long professional documents. Instead of chunking a document into embeddings and retrieving by semantic similarity, it builds a hierarchical table-of-contents-style tree and uses LLM reasoning/tree search to locate relevant sections. The project is especially relevant for documents where superficial similarity search can miss the truly relevant evidence: financial reports, SEC/regulatory filings, legal material, technical manuals, academic textbooks, and complex PDFs.

Repository metadata at capture time: **28,779 stars**, **2,441 forks**, **128 watchers**, **138 open issues**, language **Python**, license **MIT**, default branch **main**, last pushed **2026-05-05T20:53:44Z**.

## Key points

- **Reasoning-first retrieval:** PageIndex frames retrieval as relevance reasoning over a document tree, not nearest-neighbour similarity over embedded chunks.
- **No vector DB / no chunking:** the core pitch is to avoid vector databases and arbitrary chunks by preserving natural document structure.
- **Human-like navigation:** the tree resembles how an expert scans a table of contents, narrows to sections, and then reads relevant pages.
- **Traceability:** retrieval decisions can point back to page/section references, making the system easier to inspect than opaque vector search.
- **Agentic RAG path:** the README highlights an OpenAI Agents SDK demo for self-hosted agentic vectorless RAG.
- **Scale-out layer:** PageIndex File System adds a file-level tree layer for reasoning over large document corpora rather than one document at a time.
- **Commercial surface area:** the open-source repo sits alongside PageIndex Chat, MCP/API integrations, cloud OCR/tree-building, and enterprise/on-prem options.

## Why it matters

This is a useful addition to the AI research wiki because it is a concrete example of the current move beyond vanilla embedding-RAG toward **structured, reasoning-native retrieval**. For Self-OS and agent workflows, PageIndex is relevant as a potential pattern for long-document memory, research corpus navigation, due-diligence workflows, and explainable retrieval over GitHub/wiki/document archives without relying entirely on vector similarity.
...
- **Stars:** 28,779
- **Forks:** 2,441
- **Watchers/subscribers:** 128
- **Open issues:** 138
- **Primary language:** Python
- **License:** MIT
- **Created:** 2025-04-01T10:53:54Z
- **Updated:** 2026-05-07T00:57:56Z
- **Last pushed:** 2026-05-05T20:53:44Z
- **Default branch:** main

## Notable links from README

- Homepage: https://vectify.ai/pageindex
- Chat platform: https://chat.pageindex.ai
- MCP/API developer docs: https://pageindex.ai/developer
- Documentation: https://docs.pageindex.ai
- Agentic vectorless RAG demo: https://github.com/VectifyAI/PageIndex/blob/main/examples/agentic_vectorless_rag_demo.py
- PageIndex File System blog: https://pageindex.ai/blog/pageindex-filesystem
- PageIndex framework intro: https://pageindex.ai/blog/pageindex-intro
- FinanceBench result reference: https://github.com/VectifyAI/Mafin2.5-FinanceBench

## Self-OS notes

Potential angles for future compilation:

- **Concept:** vectorless RAG / reasoning-based retrieval
- **Concept:** tree-indexed document memory
- **Concept:** explainable retrieval for professional documents
- **Entity/tool:** PageIndex
- **Comparison target:** vector DB RAG, GraphRAG, hierarchical RAG, agentic document search
- **Possible operational use:** ingesting and navigating long PDFs/reports in Self-OS or supply-chain research workflows where citations and section-level traceability matter.
