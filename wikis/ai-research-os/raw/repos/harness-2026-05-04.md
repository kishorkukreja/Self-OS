...
## Summary
Harness is a Claude Code plugin/meta-skill that turns a domain description into a project-specific team of specialized agents plus the skills and coordination protocols they need. It is explicitly positioned as a team-architecture factory: pipeline, fan-out/fan-in, expert pool, producer-reviewer, supervisor, and hierarchical delegation patterns.
...
- **Language breakdown:** HTML 100.0%
- **License:** Apache-2.0
- **Stars:** 3114
- **Forks:** 465
- **Watchers:** 25
- **Open issues:** 10
- **Created:** 2026-03-26T21:22:07Z
- **Updated:** 2026-05-04T22:01:52Z
- **Last pushed:** 2026-04-18T10:38:53Z
- **Default branch:** main
- **Homepage:** https://revfactory.github.io/harness/
- **Topics:** claude-code, claude-code-plugin, harness, harness-engineering
- **Fetched README:** main/README.md

## Key points
- Generates `.claude/agents/` and `.claude/skills/` assets from a domain-level prompt.
- Encodes six reusable team-architecture patterns for Claude Code agent teams.
- Includes validation/dry-run concepts and a harness-evolution feedback loop for improving later generated harnesses.

## Why it matters
Highly relevant to Self-OS as a reference for turning recurring project/domain work into reusable operator-level agent teams and skills rather than one-off prompts.
