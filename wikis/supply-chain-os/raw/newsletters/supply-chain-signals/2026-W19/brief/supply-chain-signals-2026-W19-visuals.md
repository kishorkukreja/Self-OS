...
client: internal
confidential: false
tags: [supply-chain-signals, newsletter, visuals, charts]
status: draft
---
...
- **Concept:** "Wafer to rack: where the constraint moves."
- **Aspect ratio:** 16:9 for Substack/LinkedIn hero; crop-safe center for social.
- **Style:** Technical-schematic infographic with baoyu `dense-modules`/`bento-grid` logic. Dark navy/graphite background, copper traces, electric-green signal lines, crisp labels, no stock-photo people.
- **Subject:** Layered supply-chain map: wafer fab, HBM/advanced packaging, substrates, server/rack assembly, power equipment, liquid cooling, freight/customs, data-center site, grid connection, live operations.
...
- **Alt text:** Systems map of the AI infrastructure supply chain from semiconductor wafers to deployed data-center racks, with highlighted bottlenecks in power, memory, packaging, cooling, and logistics.
- **Caption:** AI infrastructure is a physical supply chain. The constraint may sit far outside the chip.
...
- **Structure:** Hub-and-spoke: current business plan in the center; spokes for material, duty, power, freight, capacity, supplier qualification, cash, and customer promise. Each spoke has fields: signal, decision, owner, deadline.
